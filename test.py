...
trained_model = os.path.join(cfg.train_output_dir, 'darknet19_voc07trainval_exp1_82.h5')
print("Loading trained model from ", trained_model)
...
def test_net(net, imdb, max_per_image=300, thresh=0.5, vis=False):
    ...
    for i in range(num_images):
        ...
        if vis:
            ...
            cv2.imwrite('logs/test{}.jpg'.format(i), im2show)
            #cv2.waitKey(0)
